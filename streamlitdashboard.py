...
with col2:
    st.markdown("""
        <div style='display: flex; align-items: center; height: 100%;'>
            <h1 style='font-size: clamp(20px, 3vw, 36px); color: #044B9A; margin: 18px 0 0 0; line-height: 1.2;'>
...
with tab2:
    ...
    altair_palettes = {
        ...
        "inferno": [
            "#000004", "#1e0c48", "#57106e", "#87216b", "#ac375a",
            "#cb504a", "#e97139", "#f89441", "#fdc328", "#fcffa4"
        ],
        "turbo": [
            "#30123b", "#4143d3", "#4694e6", "#3ec4ac", "#3edd68",
            "#a8eb39", "#f9f871", "#fecf3f", "#fb7d1d", "#d11807"
        ],
        "category10": [
